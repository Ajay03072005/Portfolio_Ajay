...
import { ArrowRight, Sparkles, Code, Palette, Zap, Star, Heart, Award, TrendingUp, Rocket } from "lucide-react";
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="space-y-6">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-tight tracking-tight">
              <span className="block text-foreground/90 text-3xl sm:text-4xl md:text-5xl font-semibold mb-4 animate-slide-up drop-shadow-lg">
                Hi, I'm
              </span>
            ...
            <div className="flex items-center justify-center gap-4 animate-slide-up" style={{ animationDelay: "0.2s" }}>
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-foreground via-primary/60 to-accent bg-clip-text text-transparent drop-shadow-md hover:scale-105 transition-transform duration-300">
          ...
          <div className="max-w-4xl mx-auto animate-slide-up space-y-6" style={{ animationDelay: "0.3s" }}>
            <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground/90 leading-relaxed font-medium">
